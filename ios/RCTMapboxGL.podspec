Pod::Spec.new do |s|
  ...
  s.source_files = "RCTMapboxGL/RCTMapboxGL.{h,m}", "RCTMapboxGL/RCTMapboxGLManager.{h,m}", "RCTMapboxGL/RCTMapboxGLConversions.{h,m}", "RCTMapboxGL/RCTMapboxAnnotation.{h,m}", "RCTMapboxGL/RCTMapboxAnnotationManager.{h,m}"
